...
export const GUIDE_STRIDE = GUIDE_DIR_COUNT + 1;
export const GUIDE_BYTES = GUIDE_CELL_COUNT * GUIDE_STRIDE * 4;
export const GUIDE_PROBES = 4;
export const GUIDE_INC_MAX = 256;
